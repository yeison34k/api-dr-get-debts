...
async function packExternalModules() {
    ...
    const packageJsonPath = this.buildOptions.packagePath || path_1.default.relative(process.cwd(), path_1.default.join((0, utils_1.findUp)('package.json'), './package.json'));
