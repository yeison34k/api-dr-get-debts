...
async function bundle(incremental = false) {
    ...
    if ((0, helper_1.isESM)(this.buildOptions) && this.buildOptions.outputFileExtension === '.cjs') {
    ...
    if (!(0, helper_1.isESM)(this.buildOptions) && this.buildOptions.outputFileExtension === '.mjs') {
        // eslint-disable-next-line @typescript-eslint/ban-ts-comment
        // @ts-ignore Serverless typings (as of v3.0.2) are incorrect
